...
+ (NSString *)getEposResultText:(int)resultCode
{
    ...
    switch (resultCode) {
        ...
        case EPOS2_CODE_ERR_INVALID_PASSWORD:
            ...
            break;
        case EPOS2_CODE_ERR_INVALID_FIRM_VERSION:
            result = @"EPOS2_CODE_ERR_INVALID_FIRM_VERSION";
            break;
        case EPOS2_CODE_ERR_SSL_CERTIFICATION:
            result = @"EPOS2_CODE_ERR_SSL_CERTIFICATION";
            break;
        default:
